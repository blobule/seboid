...
public class ActivityUdeMListFeed extends Activity  {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView parent, View view, int position, long id) {
				...
				//				startActivity(in);
				Intent in = new Intent(ActivityUdeMListFeed.this, ActivityUdeMWeb.class);
	...
	static final ViewBinder VIEW_BINDER = new ViewBinder() {
		public boolean setViewValue(View view, Cursor c, int index) {
			...
			((TextView)view).setText(ActivityUdeMListFeed.feedName.get(c.getString(1)));
			return true;
		}
	};
